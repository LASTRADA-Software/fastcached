...
Shape() {
    ...
    # Every rule above is a whole-file grep, which is exactly how #1174 passed them
    # all. The per-STEP rule that caught it reads every workflow, this one included:
    # scripts/check-workflow-step-env.sh (#1448).
}
