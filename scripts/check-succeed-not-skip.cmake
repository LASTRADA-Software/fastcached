...
if(violations)
    ...
    message("")
    message("`SKIP(\"reason\")` is the whole fix. Every catch_discover_tests registration")
    message("in this tree carries SKIP_RETURN_CODE 4, so ctest scores it as SKIPPED")
    message("(#499). That mechanism is known broken the other way -- four failing")
    message("assertions also read as a skip (#1128) -- and #1152 tracks the fix.")
    message("")
