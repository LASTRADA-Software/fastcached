          ...
          "[wire][consensus][nodestatus]")
{
    ...
    // count, #1449's consensus standing and #178's identity key. Pinned, since every cut below is
    // counted from it and a record that grew would move what "older" means -- which is how this
    // case caught #1471's append, then #1449's, then #178's, rather than letting any of them shift
    // the cuts silently.
    ...
    SECTION("sixteen fields, as a build after #1449 and before #178 emits: the key is absent")
    {
        ...
        // the standing before it -- or the reply -- with it.
    ...
    SECTION("seventeen fields, this build: all four engaged")
    {
          ...
          "[wire][nodestatus][identity]")
{
    ...
    // a machine that holds no such key.
