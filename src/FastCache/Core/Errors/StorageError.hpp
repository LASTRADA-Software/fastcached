...
enum class StorageErrorCode : unsigned
{
    Ok = 0,           ///< Sentinel.
...
struct StorageError
{
    ...
    {
        return std::format(
            "StorageError(code={} system={} context={})", static_cast<unsigned>(code), systemCode, context);
    }
};
...
[[nodiscard]] constexpr std::string_view ToStringView(StorageErrorCode code) noexcept
{
    switch (code)
    {
        case StorageErrorCode::Ok:              return "Ok";
        case StorageErrorCode::KeyNotFound:     return "KeyNotFound";
        case StorageErrorCode::KeyExists:       return "KeyExists";
        case StorageErrorCode::CasMismatch:     return "CasMismatch";
        case StorageErrorCode::ValueTooLarge:   return "ValueTooLarge";
        case StorageErrorCode::OutOfMemory:     return "OutOfMemory";
        case StorageErrorCode::Corrupt:         return "Corrupt";
        case StorageErrorCode::IoError:         return "IoError";
        case StorageErrorCode::ReadOnly:        return "ReadOnly";
