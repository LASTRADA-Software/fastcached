...
enum class ProtocolErrorCode : unsigned
{
...
[[nodiscard]] constexpr std::string_view ToStringView(ProtocolErrorCode code) noexcept
{
    switch (code)
    {
        case ProtocolErrorCode::Ok:                 return "Ok";
        case ProtocolErrorCode::MalformedFrame:     return "MalformedFrame";
        case ProtocolErrorCode::LineTooLong:        return "LineTooLong";
        case ProtocolErrorCode::PayloadTooLarge:    return "PayloadTooLarge";
        case ProtocolErrorCode::InvalidCommand:     return "InvalidCommand";
        case ProtocolErrorCode::InvalidArguments:   return "InvalidArguments";
        case ProtocolErrorCode::InvalidKey:         return "InvalidKey";
        case ProtocolErrorCode::InvalidValue:       return "InvalidValue";
        case ProtocolErrorCode::UnsupportedFeature: return "UnsupportedFeature";
        case ProtocolErrorCode::AuthRequired:       return "AuthRequired";
        case ProtocolErrorCode::Truncated:          return "Truncated";
    }
    return "Unknown";
}
