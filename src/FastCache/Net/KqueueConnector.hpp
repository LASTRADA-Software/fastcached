...
///
/// The counterpart to `KqueueListener`: the connect is issued non-blocking and the
...
/// own, not this one.
///
/// The socket it produces is a `KqueueSocket` pinned to the reactor given here,
...
class KqueueConnector final: public IConnector
{
  public:
