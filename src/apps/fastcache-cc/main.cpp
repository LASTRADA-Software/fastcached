...
/// @return What happened. The localized streams are replayed here and are not handed back --
///         `MaterializedHit` records why the manifest backfill no longer reads them.
