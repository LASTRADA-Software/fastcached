...
namespace
{
                                 ...
                                 bool readerHoldsBytes)
    {
        ...
        auto watch = std::make_shared<PeerWatch>(PeerWatch { .finished = readerHoldsBytes, .gone = false, .abortive = false, .consulted = true, .counter = {} });
        if (!readerHoldsBytes)
