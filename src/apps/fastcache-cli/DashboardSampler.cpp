...
core::async::Task<FrameOutcome> TakeFrame(ILiveSubscription* subscription,
...
core::async::Task<std::expected<void, ExchangeError>> OpenStream(ILiveSubscription* subscription,
                                                                 Endpoint where,
